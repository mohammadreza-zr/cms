<?php
    ...
    if (isset($_POST['btn'])){
        $data=$_POST['frm'];
        edit_news($data, $id,'img',$result['img']);
            ...
            <div class="panel-body">
                <form role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo $result['date'];?>" type="date" name="frm[date]" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">توضیحات</label>
                        <textarea name="frm[text]"  class="form-control ckeditor" rows="8" placeholder="توضیحات محصول را وارد کنید"><?php echo $result['text'];?></textarea>
                    </div>
                    <div class="form-group">
